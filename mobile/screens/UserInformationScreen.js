...
const UserInformationScreen = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      <ImageBackground source={require('../assets/img/bia.jpg')} style={styles.coverPage}>
        <View style={{display: 'flex', flexDirection: 'row-reverse', justifyContent: 'space-between'}}>
          <View style={{flexDirection: 'row-reverse'}}>
            <TouchableOpacity style={styles.touchAble} onPress={navigateToUserSetting}>
      ...
      <View style={styles.profileContainer}>
        <Image source={require('../assets/img/giiahuy.jpeg')} style={styles.avatar}/> 
